...
def download_zip(api_url):
 try:
    ...
    print("inside the download_zip method")
    ...
    if response.status_code == 200:
        ...
        #os.system("echo '::set-output name=zipFilePath::{zip_file_path}'")
    else:
...
if __name__ == "__main__":
    ...
    api_url="https://www.free-css.com/assets/files/free-css-templates/download/page296/oxer.zip"
